...
gulp.task('sassBuild', function() {
  return gulp.src(['resources/stylesheets/*'])
...
gulp.task('serve', function() {
  ...
  gulp.watch(['resources/stylesheets/*.css', 'resources/stylesheets/*.scss'], ['cssBuild']); // css or sass changes, concatenate all css/sass, build, reload.
